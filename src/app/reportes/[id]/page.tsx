  ...
  if (!reporte) {
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        <h1 className="text-2xl font-bold text-zinc-900">Reporte no encontrado</h1>
        <Link href="/reportes" className="text-sm text-zinc-500 hover:text-zinc-900 mt-4 inline-block">
          Volver al historial
        </Link>
      </div>
    );
            ...
            {fotos.length > 1 && (
              <div className="border-t border-zinc-200 pt-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {fotos.slice(1).map((foto: string, i: number) => (
                    <div
                      key={i}
